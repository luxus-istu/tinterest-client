...
export function ProfileView() {
    ...
    return (
        <main className="px-5">
            <header className="pt-15 flex justify-between items-center">
            ...
            <section className="flex flex-col items-start justify-center bg-background pt-10">
                <section>
                    <div className="flex justify-between items-center gap-6">
                        <div 
                            className="rounded-full size-28 bg-cover bg-center"
                        ...
                        <section className="gap-2 flex flex-col">
                            ...
                            <div className="w-fit rounded-full flex items-center justify-center gap-2 bg-[#2C2C2E] py-1.5 px-2">
                                ...
                                <p className="text-white">{user.communication_preference.goal}</p>
                            </div>
                        </section>
                    </div>
                </section>
                <section className="pt-4 flex flex-col gap-4 w-full pb-10">
                    ...
                    <div className="rounded-4xl shadow-lg shadow-white/5 bg-[#0A0A0A]">
                        <div 
                            className="bg-cover bg-center w-full rounded-4xl p-6 aspect-4/6"
                            style={{ backgroundImage: `url('${displayUser.avatar_url}')` }}
                        >
                            ...
                            <section className="flex flex-col gap-1.5">
                                ...
                                <div className="grid grid-cols-3 gap-3">
                                    {interests.map((interest) => (
                                        <div key={interest.interest_id} className="w-fit rounded-lg flex items-center justify-center gap-2 bg-[#2C2C2E] py-1.5 px-3.5">
                                    ...
                                    {interests.length === 0 && (
                                        <p className="text-gray-400 col-span-3">Интересы не указаны</p>
                                    )}
                                </div>
                            </section>
                        </section>
